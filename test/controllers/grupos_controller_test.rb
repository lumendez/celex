...
class GruposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grupo" do
    assert_difference('Grupo.count') do
      post grupos_url, params: { grupo: { nombre: @grupo.nombre, profesor_nombre_id: @grupo.profesor_nombre_id } }
    end
  ...
  test "should update grupo" do
    patch grupo_url(@grupo), params: { grupo: { nombre: @grupo.nombre, profesor_nombre_id: @grupo.profesor_nombre_id } }
