...
RSpec.describe "it_inscripcion_registros/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit it_inscripcion_registro form" do
    render

    assert_select "form[action=?][method=?]", it_inscripcion_registro_path(@it_inscripcion_registro), "post" do
