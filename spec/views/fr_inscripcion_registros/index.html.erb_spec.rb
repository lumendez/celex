...
RSpec.describe "fr_inscripcion_registros/index", type: :view do
  before(:each) do
    assign(:fr_inscripcion_registros, [
      FrInscripcionRegistro.create!(
        :nombre => "Nombre",
        :paterno => "Paterno",
        :materno => "Materno",
        :idioma => "Idioma",
  ...
  it "renders a list of fr_inscripcion_registros" do
    render
