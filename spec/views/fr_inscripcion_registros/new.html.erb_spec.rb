...
RSpec.describe "fr_inscripcion_registros/new", type: :view do
  before(:each) do
    assign(:fr_inscripcion_registro, FrInscripcionRegistro.new(
      :nombre => "MyString",
      :paterno => "MyString",
      :materno => "MyString",
      :idioma => "MyString",
  ...
  it "renders new fr_inscripcion_registro form" do
    render

    assert_select "form[action=?][method=?]", fr_inscripcion_registros_path, "post" do
